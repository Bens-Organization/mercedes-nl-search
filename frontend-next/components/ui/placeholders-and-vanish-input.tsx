...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <form
      className={cn(
        "w-full relative max-w-xl mx-auto bg-white h-12 rounded-full overflow-hidden border-2 border-gray-300 focus-within:border-journey-teal transition duration-200",
        value && "bg-gray-50"
      )}
    ...
    >
      ...
      <button
        disabled={!value}
        type="submit"
        className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full disabled:bg-gray-100 bg-journey-navy hover:bg-journey-navy-dark transition duration-200 flex items-center justify-center"
      >
        <motion.svg
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="text-sm sm:text-base font-light text-gray-400 pl-4 sm:pl-10 text-left w-[calc(100%-2rem)] truncate"
            >
