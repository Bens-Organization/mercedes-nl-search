...
if __name__ == "__main__":
    print("=" * 60)
    print("Mercedes Scientific Natural Language Search API v3.1")
    print("Decoupled Middleware RAG (Fast, Accurate & Reliable)")
    print("=" * 60)
    ...
    print(f"Search Approach: Decoupled Middleware RAG")
    print(f"Middleware URL: {search_engine.middleware_url}")
    print("=" * 60)
    print("\nEndpoints:")
    ...
    print("=" * 60)
    print(f"\n⚠️  IMPORTANT: Middleware must be deployed!")
    print(f"   1. Deploy middleware to Railway: web-production-a5d93.up.railway.app")
    print(f"   2. Middleware handles category classification with RAG context")
    print(f"   3. No Typesense registration needed (decoupled architecture)")
    print("=" * 60)
    print()
