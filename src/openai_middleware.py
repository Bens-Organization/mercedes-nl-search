...
{{
    ...
    "filter_by": "",
    "sort_by": "in_stock_priority:desc,brand_priority:desc",
    "per_page": 20,
...
- `sort_by`: Use "in_stock_priority:desc,brand_priority:desc" for default, OR "in_stock_priority:desc,brand_priority:desc,price:asc" for price sort (string)
...
- ALWAYS use "in_stock_priority:desc,brand_priority:desc" for sort_by (Typesense auto-sorts by relevance after)
- Default sort: "in_stock_priority:desc,brand_priority:desc" (in-stock first, Mercedes/Tanner products, then relevance)
- Price sort: "in_stock_priority:desc,brand_priority:desc,price:asc" (in-stock first, Mercedes/Tanner, then price)
- DO NOT add "_text_match:desc" - Typesense handles relevance sorting automatically
...
→ {{"q": "test tube glass", "filter_by": "", "sort_by": "in_stock_priority:desc,brand_priority:desc", "per_page": 20, "detected_category": "Products/Glass & Plasticware/Tubes/Test Tubes", "category_confidence": 0.9, "category_reasoning": "Exact match - 'test tubes' maps to Test Tubes category in retrieved products"}}

Example 2:
Query: "nitrile gloves under $50"
Retrieved categories: ["Products/Gloves & Apparel/Gloves", "Brand: Ansell", "Size: Large"]
→ {{"q": "nitrile glove", "filter_by": "price:<50", "sort_by": "in_stock_priority:desc,brand_priority:desc", "per_page": 20, "detected_category": "Products/Gloves & Apparel/Gloves", "category_confidence": 0.85, "category_reasoning": "Clear product type matches Gloves category in retrieved results"}}

Example 3:
Query: "clear"
Retrieved categories: ["Products/Glass & Plasticware/Beakers", "Products/Lab Plasticware/Containers", "Brand: Corning"]
→ {{"q": "clear", "filter_by": "", "sort_by": "in_stock_priority:desc,brand_priority:desc", "per_page": 20, "detected_category": null, "category_confidence": 0.2, "category_reasoning": "Query is only an attribute without product type - too ambiguous"}}

Example 4:
Query: "Mercedes Scientific"
Retrieved categories: ["Brand: Mercedes Scientific", "Products/Gloves & Apparel/Gloves", "Products/Pipettes"]
→ {{"q": "Mercedes Scientific", "filter_by": "", "sort_by": "in_stock_priority:desc,brand_priority:desc", "per_page": 20, "detected_category": null, "category_confidence": 0.3, "category_reasoning": "Query is only a brand name - multiple product categories exist"}}
...
→ {{"q": "centrifuge tube 50ml capacity", "filter_by": "", "sort_by": "in_stock_priority:desc,brand_priority:desc", "per_page": 20, "detected_category": "Products/Glass & Plasticware/Tubes/Centrifuge Tubes", "category_confidence": 0.9, "category_reasoning": "Specific product type with capacity - exact category match in results"}}
...
Note: ALWAYS use "in_stock_priority:desc,brand_priority:desc" (Typesense handles relevance automatically)!
"""
